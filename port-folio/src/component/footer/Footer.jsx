    ...
    >
      <div className="container">
        ...
        <div className="social-links mt-2">
          <a href="https://github.com/" target="_blank" rel="noreferrer" className="mx-2 text-light">
            <i className="fab fa-github" style={{ color: "#FFD700", fontSize: "1.5rem" }}></i>
          </a>
          <a href="https://linkedin.com/" target="_blank" rel="noreferrer" className="mx-2 text-light">
